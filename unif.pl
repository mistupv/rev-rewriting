...
test(unif12) :-
  unify([(fun("f",[fun("g",[var("x",[])]),var("x",[])]),fun("f",[var("y",[]),cons("a",[])]))],
        success([(var("y", []),fun("g",[cons("a",[])])),(var("x",[]),cons("a",[]))])).
...
test(unif14) :-
  unify([(var("x",[]),var("y",[])),(var("y",[]),cons("a",[]))],
        success([(var("x",[]),cons("a",[])),(var("y",[]),cons("a",[]))])).

test(unif15) :-
  unify([(cons("a",[]),var("y",[])),(var("x",[]),var("y",[]))],
        success([ (var("x", []), cons("a", [])), (var("y", []), cons("a", []))])).
